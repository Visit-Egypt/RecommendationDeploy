...
@app.post('/predict_users')
def predict_users(user:int ,n:int):
    similar_users = []
...
def predict_places(place:str ,n:int):
    recomened = []
    ...
    return {'Recomened':recomened,}

result_place =  predict_places('The Egyptian Museum In Cairo',3)
result_users =  predict_users(5,3)
print((result_place,result_users))
